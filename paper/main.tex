...
What remains is the model itself, the task framing, the option naming in the
response schema, or the state representation, and we cannot separate these
here. We flag it as the
